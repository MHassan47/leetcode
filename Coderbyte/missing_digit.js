...
// a single operator (+, -, *, or /) and an equal sign (=) and return the
// digit that completes the equation.In one of the numbers in the equation,
...
// will be greater than or equal to 0 and less than or equal to 1000000.
